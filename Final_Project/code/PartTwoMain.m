...
close all
binCenters = 0:1:255;
blocksize = 50; % 32 48 64 80 96 % 200 100 50 25
% 用灰度图像做仿真实验 图像大小为512*512
% 要是用彩色图像选择绿色通道
path = 'testimg\dog4.png';
im_ori = imread(path);
if ndims(im_ori) == 3
...
figure;
subplot(1,3,1),imshow(im_ori);
subplot(1,3,2),imagesc(patt_map_end2'),colormap('hot'),colorbar;
subplot(1,3,3),imagesc(patt_map_end5'),colormap('hot'),colorbar;